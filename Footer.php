 ...
 <!-- Section: Links  -->
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3" style="padding-top: 30px;">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-home me-3"></i>Setapak, 53300 KL</p>
          <p>
            <i class="fas fa-envelope me-3"></i>
            tarcsociety@tarc.edu.my
          </p>
          <p><i class="fas fa-phone me-3"></i> + 16 534 8622</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
  ...
  <section class="bg-light text-center text-white">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © 2020 Copyright:
        <a class="text-reset fw-bold" href="#">TARC.com</a>
    </div>
    <!-- Copyright -->
 </section>
</footer>